...
const rawData = {
  ...
  Monthly: [
    { name: "Food", Spending: 8400 },
    { name: "Bills", Spending: 12000 },
    { name: "Travel", Spending: 3500 },
    { name: "Shopping", Spending: 6200 },
    { name: "Entertainment", Spending: 2900 },
    { name: "Healthcare", Spending: 1800 },
  ],
  Yearly: [
    ...
    <div className="p-6 bg-white border border-[#F6B7CF]/15 rounded-[24px] shadow-[0_12px_40px_rgba(0,0,0,0.03)] flex flex-col justify-between relative overflow-hidden h-full">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-[11px] text-[#6B7280] mt-0.5 m-0">Detailed categorical review</p>
        </div>
      ...
      <div className="w-full h-[280px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={rawData[filter]} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
