    ...
    >
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button type="button" disabled={isLoading} onClick={() => signIn("github", { callbackUrl: "/overview" })} className="w-full flex items-center justify-center gap-2 h-[46px] bg-white border border-[#F6B7CF]/20 rounded-xl text-xs font-bold text-zinc-700 hover:bg-[#FFF4F8]/30 transition-all cursor-pointer hover:-translate-y-0.5 disabled:opacity-50">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
